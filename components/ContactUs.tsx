...
export default function ContactUs() {
  return (
    <div className="place-content-center bg-lighGray mx-auto py-10 space-y-5">
      <Heading
        label="Contact Us"
        desc="Any question or remarks? Just write us a message!"
      />

      <section className="flex md:flex-row flex-col justify-center gap-5 lg:gap-20 bg-white px-3 lg:px-20 ">
        <div className="relative flex flex-col gap-5 bg-primaryRed md:p-8 px-0 py-14 rounded lg:w-[539px] md:h-[500px]">
          <Image
